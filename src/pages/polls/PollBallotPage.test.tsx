...
describe("PollBallotPage", () => {
    ...
    it("quick-ranks a candidate and submits after review", async () => {
        ...
        const candidates = [
            { programId: "p1", teamId: 1, teamName: "Alpha", logoUrl: null, division: 1, conference: "ACC", region: "East", spi: 100, spiRank: 1, powerRating: 90 },
            { programId: "p2", teamId: 2, teamName: "Beta", logoUrl: null, division: 3, conference: "CCFC", region: "West", spi: 90, spiRank: 2, powerRating: 80 },
        ];
